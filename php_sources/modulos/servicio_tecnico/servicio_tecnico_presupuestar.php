...
<table class="t1" border="1">
	...
	<tr>
		<th>falla_declarada</th>
			<td><?php if($array_servicio_tecnico["falla_declarada"]){echo $array_servicio_tecnico["falla_declarada"];}?></td>	
	</tr>
	<tr>
		<th>falla_encontrada</th>
			<td><textarea name="falla_encontrada" id="falla_encontrada" rows="5" cols="33"><?php if($array_servicio_tecnico["falla_encontrada"]){echo $array_servicio_tecnico["falla_encontrada"];}?></textarea></td>	</tr>
	</tr>
	<tr>
		<th>Presupuesto</th>
			<td><textarea name="presupuesto" id="presupuesto" rows="5" cols="33"><?php if($array_servicio_tecnico["presupuesto"]){echo $array_servicio_tecnico["presupuesto"];}?></textarea></td>	</tr>
	</tr>
	<tr>
		<th>Repuestos</th>
		...
		<th>sucursal</th>
		<td><?php if($array_servicio_tecnico["sucursal"]){echo nombre_sucursal($array_servicio_tecnico["sucursal"]);}?></td>
	</tr>
	<tr>
		<th>vendedor</th>
	...
	<tr>
		<th>Presupuesto</th>
		<td><?php if($array_servicio_tecnico["presupuesto"]){echo $array_servicio_tecnico["presupuesto"];}?></td>
	</tr>
	<tr>
		<th>repuestos</th>
		<td><?php if($array_servicio_tecnico["repuestos"]){echo $array_servicio_tecnico["repuestos"];}?></td>
	</tr>
	<tr>
		<th>total</th>
...
if($_GET["id_servicio_tecnico"] OR $array_servicio_tecnico["id"]){
    echo '<input type="hidden" name="accion" value="modificacion2">';

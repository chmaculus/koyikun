...
include_once("select_sucursal.inc.php");
echo '</select>';
echo '<input type="hidden" value="'.$busqueda.'" name="busqueda">';
...
$query='select * from seguimiento_stock where id_articulo="'.$array_articulos["id"].'" and ( origen="'.$id_sucursal.'" or destino="'.$id_sucursal.'") order by fecha, hora';
...
include_once("stock_seguimiento_listado.inc.php");

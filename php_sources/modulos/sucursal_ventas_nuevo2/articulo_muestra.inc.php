...
echo '<table>';
	...
	#------------------------------------------------------------
	include("./includes/promocion1.inc.php");
	#------------------------------------------------------------



	echo $tr.'<td><table border="1">';
	echo $tr.'<td><img src="imagenes/circulo.png" width="10" height="10" alt=""> '.$id.'</td></tr>';
	echo $tr.'<td><img src="imagenes/circulo.png" width="10" height="10" alt=""> '.$array_articulos[$count]["marca"].'</td></tr>';
	echo $tr.'<td><img src="imagenes/circulo.png" width="10" height="10" alt=""> '.$array_articulos[$count]["codigo_interno"].'</td></tr>';
	echo $tr.'<td><img src="imagenes/circulo.png" width="10" height="10" alt=""> '.$array_articulos[$count]["descripcion"].$promocion.'</td>';
	echo $tr.'<td><img src="imagenes/circulo.png" width="10" height="10" alt=""> '.$array_articulos[$count]["color"].'</td></tr>';
	echo $tr.'<td><img src="imagenes/circulo.png" width="10" height="10" alt=""> '.$array_articulos[$count]["clasificacion"].'</td></tr>';
	echo $tr.'<td><img src="imagenes/circulo.png" width="10" height="10" alt=""> '.$array_articulos[$count]["subclasificacion"].'</td>'.chr(13);
	echo $tr.'<td><img src="imagenes/circulo.png" width="10" height="10" alt=""> '.$array_articulos[$count]["contenido"].'</td></tr>';
	echo $tr.'<td><img src="imagenes/circulo.png" width="10" height="10" alt=""> '.$array_articulos[$count]["presentacion"].'</td></tr>';
	echo $tr.'<td><img src="imagenes/circulo.png" width="10" height="10" alt=""> '.$array_articulos[$count]["codigo_barra"].'</td></tr>';

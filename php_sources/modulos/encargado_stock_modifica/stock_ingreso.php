...
while($row=mysql_fetch_array($result)){
	...
	echo '<td><input type="text" name="minimo'.$row["id"].'" value="'.$array_stock["minimo"].'" size="6" readonly="readonly" ></td>';
	echo '<td><input type="text" name="maximo'.$row["id"].'" value="'.$array_stock["maximo"].'" size="6" readonly="readonly"></td>';

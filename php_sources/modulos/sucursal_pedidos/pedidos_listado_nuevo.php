...
$query='select distinct numero_pedido, sucursal  from pedidos where (estado="Preparado" or estado="Transito)" and sucursal="'.$nombre_sucursal.'" 
...
#    echo '<td>'.$inicio." ".$fin." ".$dias.'</td>';
    ...
    echo '<td><A HREF="pedido_cargar.php?numero_pedido='.$row["numero_pedido"].'&sucursal='.$row["sucursal"].'&modulo=preparad" onClick="return popup(this, \'notes\')"><button>Cargar</button></A></td>';
    echo "</tr>".chr(10);
}

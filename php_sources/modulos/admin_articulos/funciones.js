...
function cal2(idarticulos) {
	...
	total_web  = ( (temp1 * document.getElementById('margen_web'+idarticulos).value )/100 ) + ( total_con_iva * 1);
	total_con_margen  = ( (total_con_iva * document.getElementById('margen'+idarticulos).value )/100 ) + ( total_con_iva * 1);

	document.getElementById('precio_venta'+idarticulos).value = total_con_margen.toFixed(2);
	document.getElementById('precio_web'+idarticulos).value = total_web.toFixed(2);
}
...
function cal3() {
	...
	total_con_iva  = ( (temp1 * document.getElementById('iva').value )/100 *1) + ( temp1 * 1);
	total_con_margen  = ( (total_con_iva * document.getElementById('margen').value *1)/100 ) + ( total_con_iva * 1);

...
$query='select distinct subclasificacion from articulos where marca="'.mysql_real_escape_string($_POST["marca"]).'" and clasificacion="'.mysql_real_escape_string($_POST["clasificacion"]).'" and subclasificacion!="" order by subclasificacion';

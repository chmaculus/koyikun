...
?>
        ...
        <td><input type="text" name="minimo" id="minimo" value="<?php if($array_stock["minimo"]){echo $array_stock["minimo"];}?>" size="10" readonly="readonly"></td>
        <td><input type="text" name="maximo" id="maximo" value="<?php if($array_stock["maximo"]){echo $array_stock["maximo"];}?>" size="10" readonly="readonly"></td>
        <td><input type="text" name="fijo" id="fijo" value="<?php if($array_stock["fijo"]){echo $array_stock["fijo"];}?>" size="10" ></td>

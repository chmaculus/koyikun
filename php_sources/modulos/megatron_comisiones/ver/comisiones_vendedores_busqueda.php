...
<center>
<titulo>Busqueda comisiones_vendedores</titulo>
<?php
$limite=20;
$desde=$_POST["desde"];
$hasta=$_POST["hasta"];
...
$query='select * from comisiones_vendedores where titulo like "%'.$_POST["busqueda"].'%" order by genero, titulo';

...
#----------------------------------------
$query='select * from tarjetas where id="'.$_POST["id_tarjeta"].'"';
...
$query='select * from tarjetas_coeficientes where id_tarjeta="'.$_POST["id_tarjeta"].'" limit 0,1000';

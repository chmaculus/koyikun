...
$query1='select * from tarjetas where id="'.$_GET["id_tarjetas"].'" limit 0,1';
$result1=mysql_query($query1);
$array1=mysql_fetch_array($result1);
if(mysql_error()){echo mysql_error()."<br>".$query1."<br>";}


$query='select * from tarjetas_coeficientes where id_tarjeta="'.$_GET["id_tarjetas"].'" order by cantidad_pagos limit 0,1000';

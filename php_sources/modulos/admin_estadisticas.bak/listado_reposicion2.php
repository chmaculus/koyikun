...
while($row=mysql_fetch_array($result)){
    ...
    $total_pedir=$total_pedir +( $_POST["reponer".$row["id_articulo"]] * $_POST["costo".$row["id_articulo"]]);
    	...
    	}elseif($_POST["reponerb".$row["id_articulo"]]>0){
			$reponer=$_POST["reponerb".$row["id_articulo"]];    		
    	}
    	echo $_POST["reponerb".$row["id_articulo"]];
    	echo "<br>";
...
/*
#generar consulta control pedidos

mysql> create table pedidos_control (
...
$q22='insert into pedidos_control set 	numero_pedido="'.$numero_pedido.'", 
					empresa="'.$empresa.'",
					responsable_pedido="'.$_POST["responsable"].'",

...
<center>
<titulo>Busqueda clientes_persona2</titulo>
<?php
$limite=20;
$desde=$_POST["desde"];
$hasta=$_POST["hasta"];
...
$query='select * from clientes_persona2 where blabla like "%'.$_POST["busqueda"].'%"';
...
while($row=mysql_fetch_array($result)){
	...
	echo '<td>'.$row["hora"].'</td>';
	echo '<td><A HREF="clientes_persona2_ingreso.php?id_clientes_persona2='.$row["id"].'"><button>Modificar</button></A></td>';
	echo '<td><A HREF="clientes_persona2_eliminar.php?id_clientes_persona2='.$row["id"].'"><button>Eliminar</button></A></td>';
	echo "</tr>".chr(13);
}
echo "</table>";

...
<tr>
	...
	<td>
		...
		<tr>
			<td>Precio base</td>
			<td>Porcentaje publico</td>
			<td>Porcentaje tarjeta</td>
		</tr>
		<tr>
	 
			<td><input type="text" name="precio_base" size="6" value="<?php if($array_precios["precio_base"]){echo $array_precios["precio_base"];} ?>" ></td>
			<td><input type="text" name="porcentaje_contado" size="6" value="<?php if($array_precios["porcentaje_contado"]){echo $array_precios["porcentaje_contado"];} ?>" ></td>
			<td><input type="text" name="porcentaje_tarjeta" size="6" value="<?php if($array_precios["porcentaje_tarjeta"]){echo $array_precios["porcentaje_tarjeta"];} ?>" ></td>
		</tr>
		</table>
	</td>
</tr>

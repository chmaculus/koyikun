...
#devuelve 2 columnas en la tabla
	echo '<td><a href="articulos_ingreso.php?id_articulos='.$id_articulos.'"><button>Modificar</button></a></td>';
	echo '<td><a href="articulos_eliminar.php?id_articulos='.$id_articulos.'"><button>Eliminar</button></a></td>';
	echo '<td><a href="../promociones/promociones_ingreso.php?id_articulos='.$id_articulos.'"><button>Promocion</button></a></td>';
}
#-----------------------------------------------------------------

...
$query='select * from clientes_persona where apellido like "%'.$_POST["busqueda"].'%" OR
 			nombres like "%'.$_POST["busqueda"].'%" OR
 			dni like "%'.$_POST["busqueda"].'%" OR
 			carnet like "%'.$_POST["busqueda"].'%" OR
   		codigo_barras like "%'.$_POST["busqueda"].'%" OR
    		provincia like "%'.$_POST["busqueda"].'%" OR
     		ciudad like "%'.$_POST["busqueda"].'%" OR
     		apellido like "%'.$_POST["busqueda"].'%"
';

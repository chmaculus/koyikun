...
while($row=mysql_fetch_array($result)){
	...
	echo '<td><A HREF="../enc_articulos/articulos_ingreso.php?id_articulos='.$row["id"].'" onClick="return popup(this, \'notes\')"><button>Modificar</button></A></td>';
	echo '<td><A HREF="../enc_articulos/articulos_eliminar.php?id_articulos='.$row["id"].'" onClick="return popup(this, \'notes\')"><button>Eliminar</button></A></td>';

...
<html>
	<head>
		...
		<link href="../../includes/js/calendario/calendario/calendar-blue.css" rel="stylesheet" type="text/css">
		<script type="text/JavaScript" language="javascript" src="../../includes/js/calendario/calendar.js"></script>
		<script type="text/JavaScript" language="javascript" src="../../includes/js/calendario/lang/calendar-sp.js"></script>
		<script type="text/JavaScript" language="javascript" src="../../includes/js/calendario/calendar-setup.js"></script>
				...
				<table class="fuente8" width="98%" cellspacing=0 cellpadding=3 border=0>
				  <tr>
					...
					<td colspan="10" valign="middle">
						<input NAME="codigo_barras" type="text" class="cajaMedia" id="codigo_barras" size="15" maxlength="15"> 
						<img src="./img/calculadora.jpg" border="1" align="absmiddle" onClick="validarArticulo()" onMouseOver="style.cursor=cursor" title="Validar codigo de barras">     
						<img src="./img/ver.png" width="16" height="16" onClick="ventanaArticulos()" onMouseOver="style.cursor=cursor" title="Buscar articulo">
					</td>

					<td>Marca</td>
					<td><input NAME="marca" type="text" class="cajaMedia" id="marca" size="30" maxlength="30" readonly></td>
					...
					<td width="19%"><input NAME="clasificacion" type="text" class="cajaMedia" id="clasificacion" size="30" maxlength="30" readonly></td>

				  </tr>
				  <tr>
					<td width="5%">Subclasificacion</td>
					<td width="19%"><input NAME="subclasificacion" type="text" class="cajaMedia" id="subclasificacion" size="30" maxlength="30" readonly></td>

					<td width="5%">Contenido</td>
					<td width="19%"><input NAME="contenido" type="text" class="cajaMedia" id="contenido" size="30" maxlength="30" readonly></td>

					<td width="5%">Presentacion</td>
					<td width="19%"><input NAME="presentacion" type="text" class="cajaMedia" id="presentacion" size="30" maxlength="30" readonly></td>

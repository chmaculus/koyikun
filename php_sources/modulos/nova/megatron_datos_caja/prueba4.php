...
$query='select distinct fecha from datos_caja order by fecha';
$result=mysql_query($query)or die(mysql_error());
		...
		/*	$cp5++;
			...
			*/
			...
			while($row4=mysql_fetch_array($res4)){
				echo  "			<tr><td>Fecha</td><td>".$row["fecha"]."</td>".chr(13);
				echo  "			<td>Sucursal</td><td>".$row2["numero_suc"]."</td>".chr(13);
				echo  "			<td>Turno</td><td>".$row3["turno"]."</td></tr>".chr(13);
				echo  "			<tr><td>TE</td><td>".$row4["total_efectivo"]."</td></tr>".chr(13);
				echo  "			<tr><td>TT</td><td>".$row4["total_tarjeta"]."</td></tr>".chr(13);
				echo  "			<tr><td>SC</td><td>".$row4["sin_comision"]."</td></tr>".chr(13);
				echo  "			<tr><td>TT2</td><td>".( $row4["total_efectivo"] + $row4["total_tarjeta"] )."</td></tr>".chr(13);
			}
			//calcula_total_dia();
			echo  "			</td>".chr(13);
		}
		
		//if($rows3 <2 ){	echo '		<td></td><td></td>'.chr(13); 	}

...
$query='select distinct subclasificacion from ventas_estadistica where marca="'.$_POST["marca"].'" and clasificacion="'.$_POST["clasificacion"].'" and subclasificacion!="" order by subclasificacion';

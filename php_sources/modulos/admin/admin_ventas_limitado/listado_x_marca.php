...
while($row=mysql_fetch_array($result)){
	...
	echo '<td>'.str_replace('.', ',', $total_marca).'</td>';
	echo '<td>'.calcula_total_unidades_marca( $row["marca"], $sucursal ,fecha_conv("/",$_POST["fecha_desde"]), fecha_conv("/",$_POST["fecha_hasta"] )).'</td>';

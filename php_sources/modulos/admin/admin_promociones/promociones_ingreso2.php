...
<form action="promociones_update3.php" method="post" enctype="multipart/form-data">
<table border="1" class="t1">
<tr>
	<th>Sucursal</th>
...
echo '<td><input type="text" name="precio_promocion" value="'.$precio.'" size="6"></td>';
echo '<td><input type="text" name="fecha_inicio" id="fecha_inicio" value="'.$fecha_inicio.'" size="10"></td>';
echo '<td><input type="text" name="fecha_finaliza" id="fecha_finaliza" value="'.$fecha_finaliza.'" size="10"></td>';

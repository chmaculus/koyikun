...
$q='update stock set stock="'.$_POST["stock_nuevo"].'", minimo="'.$_POST["minimo"].'", maximo="'.$_POST["maximo"].'", fecha="'.$fecha.'", hora="'.$hora.'" where id_articulo="'.$_POST["id_articulos"].'" and id_sucursal="'.$id_sucursal.'"';
mysql_query($q);

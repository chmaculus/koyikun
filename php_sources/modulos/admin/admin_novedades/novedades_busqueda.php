...
<center>
<titulo>Busqueda novedades</titulo>
<?php
$limite=20;
$desde=$_POST["desde"];
$hasta=$_POST["hasta"];
...
$query='select * from novedades where titulo like "%'.$_POST["busqueda"].'%" order by genero, titulo';
...
echo '<tr>';
	...
	echo '<th>motivo</th>';
	echo '<th>texto</th>';
	echo '<th>vigencia_inicio</th>';
	echo '<th>vigencia_finaliza</th>';
	echo '<th>fecha</th>';
	echo '<th>hora</th>';
	echo "<td></td>";
	echo "<td></td>";

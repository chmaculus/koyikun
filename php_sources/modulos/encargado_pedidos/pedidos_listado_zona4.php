...
$query='select distinct pedidos.numero_pedido, pedidos.sucursal, pedidos.fecha from pedidos,marcas_zonas where pedidos.finalizado="N" and pedidos.marca=marcas_zonas.marca and pedidos.zona="4"  order by fecha, sucursal';

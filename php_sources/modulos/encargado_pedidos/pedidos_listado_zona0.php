...
#$query='select distinct numero_pedido, sucursal,fecha from pedidos where finalizado="N" order by fecha, sucursal';

#$query='select distinct pedidos.numero_pedido, pedidos.sucursal, pedidos.fecha from pedidos,marcas_zonas where pedidos.finalizado="N" and marcas_zonas.zona="5"  order by fecha, sucursal';

$query='select distinct pedidos.numero_pedido, pedidos.sucursal, pedidos.fecha from pedidos 
where	pedidos.fecha_ped_prep is NULL and
		pedidos.finalizado!="S" and 
		estado is NULL and
		(pedidos.zona is NULL or pedidos.zona=0)   

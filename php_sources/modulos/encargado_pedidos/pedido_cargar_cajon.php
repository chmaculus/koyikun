...
$query='update pedidos set estado="Transito", fecha_ped_tran="'.$fecha.'", hora_ped_tran="'.$hora.'" where estado="Preparado" and finalizado="S" and cajon="'.$_GET["cajon"].'"';
echo $query."<br><br>";
mysql_query($query);
...
/*
$query='select cajon, numero_pedido, sucursal from pedidos  where estado="Preparado" and finalizado="S" and cajon="'.$_GET["cajon"].'"';
echo $query."<br><br>";
*/
exit;

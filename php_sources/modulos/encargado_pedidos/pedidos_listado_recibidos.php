...
$query='select distinct numero_pedido, sucursal  from pedidos where estado="Transito" and 
				fecha>="'.fecha_conv("/",$fecha_desde).'" and fecha<="'.fecha_conv("/",$fecha_hasta).'" order by fecha desc';

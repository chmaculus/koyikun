...
if($_GET["numero_pedido"]){
	$query='select pedidos.* from pedidos,articulos where numero_pedido="'.$_GET["numero_pedido"].'" and sucursal="'.$_GET["sucursal"].'" and articulos.id=pedidos.id_articulo order by marca, 
					clasificacion, 
					subclasificacion, 
					contenido, 
					presentacion, 

...
function fun_marca() {
	...
	$.post("includes/select_clasificacion.inc.php", { 'marca': marca }, function(data){
...
function fun_clasificacion() {
	...
	$.post("includes/select_subclasificacion.inc.php", { 'marca': marca, 'clasificacion': clasificacion }, function(data){

...
if($rows>0){
	$q='update precios set precio_base="'.$precio_venta.'", fecha="'.$fecha.'", hora="'.$hora.'", porcentaje_tarjeta="'.$_POST["tarjeta"].'",modulo="06" where id_articulo="'.$_POST["id_articulos"].'"';
	mysql_query($q);
	if(mysql_error()){echo mysql_error()."<br>".$q."<br>".$_SERVER["SCRIPT_NAME"]."<br>";}
//	echo "q: $q<br>";
}else{
	$q='insert into precios set precio_base="'.$precio_venta.'", id_sucursal=1, fecha="'.$fecha.'", hora="'.$hora.'", porcentaje_tarjeta="'.$_POST["tarjeta"].'",modulo="07"   , id_articulo="'.$_POST["id_articulos"].'"';
	mysql_query($q);
	if(mysql_error()){echo mysql_error()."<br>".$q."<br>".$_SERVER["SCRIPT_NAME"]."<br>";}
//	echo "q: $q<br>";
}

...
if($_POST["id_articulos"]){
	...
	$array_precios=array_costos($_POST["id_articulos"]);
...
<table class="t1" border="1">
    ...
    <tr>
        ...
        <td><input type="text" name="tarjeta" id="tarjeta" value="<?php if($array_precios["porcentaje_tarjeta"]){echo $array_precios["porcentaje_tarjeta"];}?>" size="5"></td>

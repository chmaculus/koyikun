...
if ($accion=="alta") {
	...
	if (mysql_num_rows($rs_comprobar) > 0 ) {
			?><script>
				alert ("No se puede dar de alta este numero de remito con este proveedor, ya existe uno en el sistema.");
			...
			$preciototal=0;
			$baseimponible=0;
			$cabecera1="Inicio >> Compras &gt;&gt; Nuevo remito ";
...
if ($accion=="modificar") {
	...
	$preciototal=0;
	$baseimponible=0;
	if ($rs_query) { $mensaje="Los datos del remito han sido modificados correctamente"; }
	$cabecera1="Inicio >> Compras &gt;&gt; Modificar remito ";
...
if ($accion=="baja") {
	...
	$cabecera1="Inicio >> Compras &gt;&gt; Eliminar remito";
...
if ($accion=="convertir") {
	...
	if (mysql_num_rows($rs_comprobar) > 0 ) {
		...
		$cabecera1="Inicio >> Compras &gt;&gt; Convertir Remito";

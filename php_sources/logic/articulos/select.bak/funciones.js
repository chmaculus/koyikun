function fun_marca() {
	...
	$.post("./select/select_clasificacion.inc.php", { 'marca': marca }, function(data){
...
function fun_clasificacion() {
	...
	$.post("./select/select_subclasificacion.inc.php", { 'marca': marca, 'clasificacion': clasificacion }, function(data){

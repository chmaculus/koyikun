...
$sel_lineas='select * from articulos';
$rs_lineas=mysql_query($sel_lineas);

while ($row=mysql_fetch_array($rs_lineas)) {
	$i++;
	if ($i % 2) { 
		...
		$fondolinea="itemImparTabla"; 
			...
			<tr class="<? echo $fondolinea?>">
				...
				<td width="3%">
					<a href="javascript:eliminar_linea(<?php echo $codfacturatmp?>,<?php echo $numlinea?>,<?php echo $importe ?>)">
						<img src="../img/eliminar.png" border="0"></a></td>
			</tr>
<? } ?>
</table>

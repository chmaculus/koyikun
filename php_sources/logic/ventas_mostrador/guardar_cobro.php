...
if (mysql_num_rows($rs_comprueba) > 0 ) {
	?>
		...
		$sel_insert2="INSERT INTO librodiario (fecha,tipodocumento,coddocumento,codcomercial,codformapago,numpago,total) VALUES ($fechacobro','2','$codfactura','$codcliente','$formapago','$numdocumento','$importe')";

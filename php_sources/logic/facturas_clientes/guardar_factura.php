...
if ($accion=="alta") {
	...
	while ($contador < mysql_num_rows($rs_tmp)) {
		...
		$vto=mysql_result($rs_tmp,$contador,"vto");
		$lote=mysql_result($rs_tmp,$contador,"lote");
		$sel_insertar="INSERT INTO factulinea 	(codfactura,	numlinea,	codfamilia,		codigo,		cantidad,	precio,		importe,	dcto, 		vto, 	lote) VALUES 
												('$codfactura','$numlinea','$codfamilia',	'$codigo',	'$cantidad','$precio',	'$importe',	'$dcto'	,	'$vto',	'$lote')";
		...
		//echo "rows: ".mysql_num_rows($rs_minimos)."<br>";

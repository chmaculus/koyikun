			  ...
			  <div id="frmBusqueda">
				...
				<table class="fuente8" width="98%" cellspacing=0 cellpadding=3 border=0>
				  <tr>
					...
					<td colspan="5"><input NAME="referencia" type="text" class="cajaMedia" id="referencia" size="15" maxlength="15" readonly> <img src="../img/ver.png" width="16" height="16" onClick="ventanaArticulos()" onMouseOver="style.cursor=cursor" title="Buscar articulos"></td>
					<td>Descripcion</td>
					<td width="19%"><input NAME="descripcion" type="text" class="cajaMedia" id="descripcion" size="30" maxlength="30" readonly></td>
					<td width="5%">Vencimiento</td>
					<td width="5%"><input NAME="vencimiento" type="text" class="cajaMinima" id="vencimiento" size="10" maxlength="10"> </td>
					<td width="5%">Lote</td>
					<td width="5%"><input NAME="lote" type="text" class="cajaMinima" id="lote" size="10" maxlength="10" ></td>
				  </tr>
				  <tr>

...
$sel_alb="SELECT * FROM presupuestos WHERE codalbaran='$codalbaran'";
...
$fechahoy=date("Y-m-d");
$sel_albaran="INSERT INTO presupuestostmp (codalbaran,fecha) VALUE ('','$fechahoy')";
...
while ($contador < mysql_num_rows($rs_lineas)) {
	...
	$sel_tmp="INSERT INTO presupuestoslineatmp (codalbaran,numlinea,codfamilia,codigo,cantidad,precio,importe,dcto) VALUES ('$codalbarantmp','','$codfamilia','$codigo','$cantidad','$precio','$importe','$dcto')";
        ...
        <script type="text/javascript">
			  ...
			  <div id="frmBusqueda">
				...
				<table class="fuente8" width="98%" cellspacing=0 cellpadding=3 border=0>
				  ...
				  <tr>
					<td>Descripcion</td>
					<td width="19%"><input NAME="descripcion" type="text" class="cajaMedia" id="descripcion" size="30" maxlength="30"></td>

...
if ($modif<>1) {
		...
		if ($retorno==0) {	
				...
				$sel_insert="INSERT INTO presupuestoslineatmp (codalbaran,numlinea,codigo,codfamilia,cantidad,precio,importe,dcto) VALUES ('$codalbarantmp','','$codarticulo','$codfamilia','$cantidad','$precio','$importe','$descuento')";
...
<?php
$sel_lineas="SELECT presupuestoslineatmp.*,articulos.*,familias.nombre as nombrefamilia FROM presupuestoslineatmp,articulos,familias WHERE presupuestoslineatmp.codalbaran='$codalbarantmp' AND presupuestoslineatmp.codigo=articulos.codarticulo AND presupuestoslineatmp.codfamilia=articulos.codfamilia AND articulos.codfamilia=familias.codfamilia ORDER BY presupuestoslineatmp.numlinea ASC";

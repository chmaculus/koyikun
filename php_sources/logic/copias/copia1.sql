...
--
-- Host: localhost    Database: logicagl_factura
-- ------------------------------------------------------
...
CREATE TABLE `albaranestmp` (
  ...
  `fecha` date NOT NULL DEFAULT '0000-00-00',
  PRIMARY KEY (`codalbaran`)
) ENGINE=MyISAM AUTO_INCREMENT=4 DEFAULT CHARSET=latin1 COMMENT='Temporal de albaranes para controlar acceso simultaneo';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `articulos` VALUES (1,1,'1','windows xp ',30,1,1,'win-xp',1,8,2,'1','sistema operativo Microsoft','0000-00-00',1,1,'0','','se puede vender sin disco',120.00,120.00,130.00,NULL,180.00,'8400000000017','foto1.jpg','0');
...
INSERT INTO `clientes` VALUES (1,'consumidor final','','no consta',0,'no consta',0,0,'','','','','','','0');
...
CREATE TABLE `cobros` (
  ...
  `observaciones` text NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='Cobros de facturas a clientes';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `cobros` VALUES (1,1,1,440.8,1,'23180321','2012-05-12','pagado');
...
INSERT INTO `embalajes` VALUES (1,'predeterminado','0');
...
INSERT INTO `entidades` VALUES (1,'banco nacion','0');
...
INSERT INTO `factulinea` VALUES (1,1,1,'1',1,190,190,0),(1,2,1,'1',1,190,190,0),(3,2,1,'',1,0,0,0),(2,1,1,'1',1,190,190,0),(3,3,1,'',1,0,0,0),(3,1,1,'1',1,190,190,0),(3,4,1,'',1,0,0,0),(3,5,1,'1',1,120,120,0),(2,2,1,'',1,0,0,0),(2,3,1,'',1,0,0,0),(4,1,1,'1',1,23.1,23.1,0),(4,2,1,'',1,0,0,0),(5,1,1,'1',1,23.2,23.2,0);
...
INSERT INTO `factulineatmp` VALUES (20,1,1,'1',1,23.2,23.2,0),(19,2,1,'',1,0,0,0),(19,1,1,'1',1,23.1,23.1,0),(18,2,1,'',1,0,0,0),(18,1,1,'1',1,23.1,23.1,0),(16,1,1,'1',1,23.1,23.1,0);
...
) ENGINE=MyISAM AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 COMMENT='facturas de ventas a clientes';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `facturas` VALUES (1,'2012-05-12',16,1,'1',440.8,'0000-00-00','0'),(2,'2012-05-12',16,1,'1',220.4,'0000-00-00','0'),(3,'2012-05-12',16,1,'1',359.6,'0000-00-00','0'),(4,'2012-05-23',16,1,'1',26.796,'0000-00-00','0'),(5,'2012-05-23',16,1,'1',26.912,'0000-00-00','0');
...
CREATE TABLE `facturastmp` (
  ...
  `fecha` date NOT NULL,
  PRIMARY KEY (`codfactura`)
) ENGINE=MyISAM AUTO_INCREMENT=22 DEFAULT CHARSET=utf8 COMMENT='temporal de facturas a clientes';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `facturastmp` VALUES (21,'2012-05-23'),(20,'2012-05-23'),(19,'2012-05-23'),(18,'2012-05-23'),(17,'2012-05-23'),(16,'2012-05-23');
...
INSERT INTO `familias` VALUES (1,'productos','0');
...
INSERT INTO `formapago` VALUES (1,'efectivo-cheque','0');
...
INSERT INTO `impuestos` VALUES (1,'local',30,'0');
...
CREATE TABLE `librodiario` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='Movimientos diarios';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `librodiario` VALUES (1,'2012-05-12','2','1',1,1,'23180321',440.8);
...
INSERT INTO `proveedores` VALUES (1,'shopping','20231803212','acc. este sin nro.',0,'guaymallen',1,'0000299838746675','5500','15342333','15223334','fernanditososa@gmail.com','www.logicaglobal.com.ar','0');
...
INSERT INTO `provincias` VALUES (1,'Alava'),(2,'Albacete'),(3,'Alicante'),(4,'Almeria'),(5,'Asturias'),(6,'Avila'),(7,'Badajoz'),(8,'Baleares'),(9,'Barcelona'),(10,'Burgos'),(11,'Caceres'),(12,'Cadiz'),(13,'Cantabria'),(14,'Castellon'),(15,'Ceuta'),(16,'Ciudad Real'),(17,'Cordoba'),(18,'La Coruña'),(19,'Cuenca'),(20,'Gerona'),(21,'Granada'),(22,'Guadalajara'),(23,'Guipuzcoa'),(24,'Huelva'),(25,'Huesca'),(26,'Jaen'),(27,'Leon'),(28,'Lerida'),(29,'Lugo'),(30,'Madrid'),(31,'Malaga'),(32,'Melilla'),(33,'Murcia'),(34,'Navarra'),(35,'Orense'),(36,'Palencia'),(37,'Las Palmas'),(38,'Pontevedra'),(39,'La Rioja'),(40,'Salamanca'),(41,'Sta. Cruz de Tenerife'),(42,'Segovia'),(43,'Sevilla'),(44,'Soria'),(45,'Tarragona'),(46,'Teruel'),(47,'Toledo'),(48,'Valencia'),(49,'Valladolid'),(50,'Vizcaya'),(51,'Zamora'),(52,'Zaragoza');
...
INSERT INTO `ubicaciones` VALUES (1,'urbano','0');
...
-- Dump completed on 2012-05-23 16:53:27

...
while($row=mysql_fetch_array($res)){
	echo '# empieza pedido '.$row[0].'--------------------------------------------------------------------------------------------------------------------------------------'.chr(10);
	...
	echo "#cant zonas:  ".mysql_num_rows($res2).chr(10);
	echo "#while zonas ".chr(10)."#".$q.chr(10);
	$count1=0;
	#---------------------------------------------------------------------------------
	while($zzzz=mysql_fetch_array($res2))
	{
		echo chr(10).'# empieza zona '.$zzzz[0].'--------------------------------------------------------------------------------------------------------------------------------------'.chr(10);
		if($count1>0)
		{
			...
			$res3=mysql_query($q);
			echo "#cant marcas: ".mysql_num_rows($res3).chr(10);
			echo "#while marcas".chr(10)."#".$q.";".chr(10).chr(10);
			#-----------------------------------------------------------
			while($arr_marca=mysql_fetch_array($res3))
			{
				echo "#marca: ".$arr_marca[0]." z:".$zzzz[0].$arr_marca[1].chr(10);
				{
					incrementa_n_pedido($row[1]);
	...
	}else 
	{
		...
		$count1++;
		echo '# termina zona '.$zzzz[0].'--------------------------------------------------------------------------------------------------------------------------------------'.chr(10).chr(10);
	}
	#-----------------------------------------------------------------------------------------------

echo '# termina pedido '.$row[0].'--------------------------------------------------------------------------------------------------------------------------------------'.chr(10);
echo chr(10);
echo chr(10);
echo chr(10);
}

...
$q='select distinct pedidos_temp_nuevo.id_sucursal as suc from pedidos_temp_nuevo, marcas_zonas where pedidos_temp_nuevo.marca=marcas_zonas.marca and pedidos_temp_nuevo.clasificacion=marcas_zonas.clasificacion and marcas_zonas.zona="5" order by suc';
...
while($row=mysql_fetch_array($result)){
	$q='select pedidos_temp_nuevo.id as id from pedidos_temp_nuevo, marcas_zonas where pedidos_temp_nuevo.marca=marcas_zonas.marca and pedidos_temp_nuevo.clasificacion=marcas_zonas.clasificacion and marcas_zonas.zona="5" order by id';
	echo $q.";".chr(10);

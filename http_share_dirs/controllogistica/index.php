...
slides[1] = new Array(15, "control", "control.php");
slides[2] = new Array(15, "reparto1", "reparto1.php");
slides[3] = new Array(15, "reparto2", "reparto2.php");
slides[4] = new Array(15, "reparto3", "reparto3.php");
slides[5] = new Array(15, "reparto4", "reparto4.php");
slides[6] = new Array(15, "reparto5", "reparto5.php");

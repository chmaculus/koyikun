...
slides[1] = new Array(<?php echo $tiempo; ?>, "Comparativos", "comparativos.php");
slides[2] = new Array(<?php echo $tiempo; ?>, "Asistencias 2", "total_dia.php");
slides[3] = new Array(<?php echo $tiempo; ?>, "Asistencias 3", "comparativos.php");
slides[4] = new Array(<?php echo $tiempo; ?>, "Pedidos", "comparativos.php");
slides[5] = new Array(<?php echo $tiempo; ?>, "Pedidos", "slideshow_asistencias.php//////////");
function MenuInit()
{
    var html = "";
...
function MenuShow()
{
    ...
    menu_timer = setTimeout("MenuHide()", 30);
}
function MenuHide()
{

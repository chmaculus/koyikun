...
slides[1] = new Array(15, "Asistencias 1", "asistencias_parte1.php");
slides[2] = new Array(15, "Asistencias 2", "asistencias_parte2.php");
slides[3] = new Array(15, "Asistencias 3", "asistencias_parte3.php");
slides[4] = new Array(15, "Asistencias 4", "asistencias_parte4.php");
slides[5] = new Array(15, "Pedidos", "pedidos_listado.php");
function MenuInit()
{
    var html = "";
...
function MenuShow()
{
    ...
    menu_timer = setTimeout("MenuHide()", 300);
}
function MenuHide()
{

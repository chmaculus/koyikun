...
slides[2] = new Array(<?php echo $tiempo; ?>, "Ventas franquicia", "ventas_sucursales_franquicia.php");

/*
slides[2] = new Array(60, "logistica", "controllogistica.php");
slides[3] = new Array(60, "Ventas online", "ventas_online.php");
slides[4] = new Array(60, "Ventas franquicias", "ventas_franquicias.php");
slides[5] = new Array(<?php echo $tiempo; ?>, "Comparativos", "comparativos.php");
slides[6] = new Array(<?php echo $tiempo; ?>, "Marcas", "marcas_listado.php");
slides[7] = new Array(<?php echo $tiempo; ?>, "Total dia", "total_dia.php");
slides[8] = new Array(60, "Pedidos", "pedidos_listado.php");
slides[9] = new Array(60, "Pedidos", "deposito_ingresos1_listado.php");
slides[10] = new Array(15, "Asistencias 1", "asistencias_parte1.php");
slides[11] = new Array(15, "Asistencias 2", "asistencias_parte2.php");
slides[12] = new Array(15, "Asistencias 3", "asistencias_parte3.php");
slides[13] = new Array(15, "Asistencias 4", "asistencias_parte4.php");
slides[14] = new Array(15, "Asistencias 4", "asistencias_parte5.php");
slides[15] = new Array(15, "ventas hora", "ventas_listado_hora.php");
slides[16] = new Array(15, "ventas hora sucursal", "ventas_listado_hora_sucursal.php");
*/

/*
slides[5] = new Array(<?php echo $tiempo; ?>, "datos", "index7.php");
slides[3] = new Array(<?php echo $tiempo; ?>, "Pedidos", "slideshow_asistencias.php//////////");

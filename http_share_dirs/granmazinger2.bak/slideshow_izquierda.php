...
slides[1] = new Array(30, "Comparativos", "comparativos.php");
slides[2] = new Array(30, "Asistencias 2", "total_dia.php");
slides[3] = new Array(30, "Asistencias 3", "comparativos.php");
slides[4] = new Array(30, "Asistencias 4", "total_dia.php");
slides[5] = new Array(30, "Pedidos", "comparativos.php");
function MenuInit()
{
    var html = "";

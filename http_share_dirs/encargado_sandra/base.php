...
echo '<tr>'.chr(10);
	...
	echo '<td><a class="heading" target="centro" href="'.$prefijo.'/encargado_pedidos/pedidos_base2.php"><img src="./botones/PEDIDOS_SUCURSALES.png"></a></td>'.chr(10);
	echo '</tr>';
	...
	echo '<td><a target="centro" href="'.$prefijo.'/encargado_pedidos_recepcion_deposito/index.php"><img src="./botones/PEDIDOS_RECIBIDOS.png"></a></td>';
	echo '<td><a target="centro" href="./login/login_finaliza.php"><img src="./botones/CERRAR_SESION.png"></a></td>'.chr(10);
echo '</tr>'.chr(10);


	echo '<tr>';
	echo '<td><a target="centro" href="'.$prefijo.'/deposito_ingresos1/deposito_ingresos1_base.php"><img src="./botones/INGRESO_STOCK_POR_COMPRA.png"></a></td>';
	echo '<td><a target="centro" href="'.$prefijo.'/encargado_stock_fijos/index.php"><img src="./botones/STOCK_FIJOS.png"></a></td>';
	echo '<td><a class="heading" target="centro" href="'.$prefijo.'/encargado_stock_movimiento_interno/base.php"><img src="./botones/MOV.INTERNO.png"></a></td>'.chr(10);
	echo '<td><a class="heading" target="centro" href="'.$prefijo.'/encargado_stock_movimiento/articulos_busqueda.php"><img src="./botones/MOV.STOCK.png"></a></td>'.chr(10);
echo '</tr>'.chr(10);

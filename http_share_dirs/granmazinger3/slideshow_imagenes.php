...
$q='select id from articulos_lanzamientos';
$res=mysql_query($q);
...
$count=1;
for($i=0;$i<=($div -1);$i++){
    echo 'slides['.$count.'] = new Array(15, "'.$i.'", "lanzamientos.php?id='.$i.'");'.chr(10);
    //echo "jejeje $row[0] <br>";
    $count++;
}
echo 'slides['.$count.'] = new Array(12, "'.($i+1).'", "marcas_listado.php");'.chr(10);
$count++;
echo 'slides['.$count .'] = new Array(12, "Ventas sucursales", "ventas_sucursales.php");';
